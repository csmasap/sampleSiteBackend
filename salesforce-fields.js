...
const OPPORTUNITY_DISCUSSED_FIELDS = {
  ...
  INTERNAL_Q2: 'Internal_Q_2__c',
  INTERNAL_ANSWER2: 'Internal_Answer_2__c',
  INTERNAL_Q3: 'Internal_Q_3__c',
  INTERNAL_ANSWER3: 'Internal_Answer_3__c',
  CANDIDATE:'TR1__Candidate__r.Name'
};

// Hardcoded Record IDs
const RECORD_IDS = {
  JOB_ID: 'a0WPM000004IgMf2AK',
  OPPORTUNITY_DISCUSSED_ID: 'a0bPM00000U6EGlYAN'
};
...
const QUERIES = {
  ...
  GET_OPPORTUNITY_DISCUSSED: `SELECT ${OPPORTUNITY_DISCUSSED_FIELDS.ID}, 
    ...
    ${OPPORTUNITY_DISCUSSED_FIELDS.INTERNAL_Q2},
    ${OPPORTUNITY_DISCUSSED_FIELDS.INTERNAL_ANSWER2}, 
    ${OPPORTUNITY_DISCUSSED_FIELDS.INTERNAL_Q3},
    ${OPPORTUNITY_DISCUSSED_FIELDS.INTERNAL_ANSWER3},
    ${OPPORTUNITY_DISCUSSED_FIELDS.CANDIDATE}  
